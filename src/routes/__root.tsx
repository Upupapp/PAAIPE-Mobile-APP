...
import { markListingCapture } from "../lib/listing-capture";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "PAAIPE agent portal mobile experience." },
      { name: "author", content: "PAAIPE" },
      { name: "theme-color", content: "#2F6CF0" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "mobile-web-app-capable", content: "yes" },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "PAAIPE Agent Portal" },
      { property: "og:description", content: "PAAIPE agent portal mobile experience." },
